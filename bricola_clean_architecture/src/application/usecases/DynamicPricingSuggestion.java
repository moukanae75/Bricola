...
/**
 * USE CASE: DynamicPricingSuggestion
 *
 * Mathematical foundation: Linear Programming (LP) — Primal form
 *
 * Maximize: revenue = price * expectedDemand(price)
 * Subject to market and client constraints.
 *
 * D(p) = D0 - elasticity * p
 * p* = D0 / (2 * elasticity)   (unconstrained optimum)
 */
