...
/**
 * USE CASE: ChurnRiskPredictor
 *
 * Mathematical foundation: Survival Analysis — Exponential Decay Model
 *
 * Model: S(t) = e^(-λ * t)
 *   where:
 *     S(t) = survival probability (P(still active) at day t)
 *     λ    = hazard rate (higher λ = faster churn)
